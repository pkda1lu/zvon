...
- **Vlyne ID**: Единый вход для всех проектов экосистемы Vlyne — аккаунт Zvon и есть Vlyne ID
  (OAuth 2.1 / OpenID Connect, см. [docs/vlyne-id.md](docs/vlyne-id.md)).
...
Проект распространяется под лицензией MIT. Разработано с страстью к качественной связи.
