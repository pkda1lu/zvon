                ...
                <main className="docs-main">
                    {activeTab === 'general' ? (
                        <div className="docs-content">
                            ...
                            <section>
                                <h2>🚀 Начало работы</h2>
                                <p>Чтобы начать пользоваться Zvon, зарегистрируйтесь или войдите в свою учетную запись. Вы можете использовать веб-версию или скачать клиент для Windows.</p>
                                <ul>
                            ...
                            <section>
                                ...
                                <p>Zvon поддерживает высококачественный звук и передачу видео в 4K.</p>
                                <ul>
                            ...
                            <section>
                                ...
                                <p>Zvon использует современные стандарты безопасности для защиты ваших данных.</p>
                                <ul>
  ...
  if(actionId === "skip_track") {
     // Ваша логика пропуска трека
                            ...
                            <section>
                                ...
                                <p>Zvon использует RTC-узлы для передачи звука. Рекомендуется использовать официальный LiveKit SDK для Node.js для подключения к голосовым каналам.</p>
                                <div className="code-block">
