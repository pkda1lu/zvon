            ...
            <div className="vidoc-layout">
                ...
                <main className="vidoc-main">
                    ...
                    <Section
                        id="scopes"
                        title="Права доступа"
                        lead="Vlyne ID выдаёт доступ только к данным аккаунта. Просите ровно то, что нужно: каждое право — отдельная строка на экране согласия, и лишние уменьшают шанс, что человек нажмёт «Разрешить»."
                    >
                        ...
                        <p className="vidoc-muted">
                            Список закрыт и намеренно короткий. Vlyne ID отвечает за вход и за данные самого
                            аккаунта; подписки, платежи и прочее принадлежат своим сервисам, и доступ к ним
                            выдаёт тот, кто ими распоряжается, — здесь таких прав нет и не будет.
                        </p>
                    </Section>
