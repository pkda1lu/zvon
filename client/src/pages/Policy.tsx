    ...
    return (
        <div className="docs-container" style={{ padding: '0 20px', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            <div className="policy-content" style={{
                ...
                <h1 style={{ fontSize: '48px', fontWeight: 900, marginBottom: '20px', letterSpacing: '-1.2px', background: 'linear-gradient(135deg, #fff 0%, #64748b 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Политика конфиденциальности Zvon</h1>
                <p className="lead" style={{ fontSize: '20px', color: '#94a3b8', marginBottom: '80px', lineHeight: 1.6 }}>
                    Этот документ объясняет, как мы собираем, используем, передаем и защищаем вашу информацию. Мы обязуемся защищать частную жизнь каждого пользователя Zvon.
                </p>
                ...
                <div className="policy-sections" style={{ display: 'grid', gap: '80px' }}>
                    ...
                    <section>
                        ...
                        <div style={{ color: '#cbd5e1', lineHeight: '2', fontSize: '15.5px' }}>
                            Zvon **не продает** вашу персональную информацию рекламодателям или сторонним компаниям. Мы можем передавать информацию только в случаях:
                            <ul style={{ paddingLeft: '20px', marginTop: '16px' }}>
                                <li><strong>Публичный контент:</strong> Сообщения и данные профиля видны другим пользователям Zvon в соответствии с настройками прав доступа (серверные каналы, личные переписки).</li>
                    ...
                    <section>
                        ...
                        <div style={{ color: '#cbd5e1', lineHeight: '2', fontSize: '15.5px' }}>
                            Zvon предоставляет вам широкий спектр инструментов для управления данными:
                            <ul style={{ paddingLeft: '20px', marginTop: '16px' }}>
                ...
                <div style={{ marginTop: '100px', paddingTop: '40px', borderTop: '1px solid rgba(255, 255, 255, 0.05)', textAlign: 'center', color: '#64748b', fontSize: '13px' }}>
                    Zvon Platform • Privacy & Safety Center • Последнее обновление: {new Date().toLocaleDateString('ru-RU')}
                </div>
            </div>
        </div>
    );
