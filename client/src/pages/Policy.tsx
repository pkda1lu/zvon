    ...
    return (
        <div style={{
            ...
            <p className="lead" style={{ fontSize: '18px', color: '#94a3b8', marginBottom: '40px' }}>
                Мы ценим ваше доверие и стремимся сделать Zvon самым безопасным местом для общения.
            </p>

            <section style={{ marginBottom: '40px' }}>
                <h2>1. Общие положения</h2>
                <p>Zvon — это сервис для обмена сообщениями и мультимедиа. Используя сервис, вы соглашаетесь не загружать вредоносный контент и уважать других пользователей.</p>
            </section>
