...
const PostBlockRenderer: React.FC<PostBlockRendererProps> = ({ block, currentUserId, interactive = false, onVote }) => {
  ...
  if (block.type === 'poll') {
    ...
    return (
      <div style={{ ...wrap, background: 'rgba(255,255,255,0.04)', border: '1px solid var(--glass-border, rgba(255,255,255,0.1))', borderRadius: 14, padding: 16 }}>
