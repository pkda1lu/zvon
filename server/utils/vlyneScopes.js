...
const SCOPES = {
  ...
  telegram: {
    ...
    description: 'Привязан ли аккаунт к Telegram и под каким именем (нужно для VPN-подписки)'
  },
  'vpn:read': {
    title: 'Состояние VPN-подписки',
    description: 'Срок действия, остаток трафика и список серверов'
  },
  'vpn:manage': {
    title: 'Управление VPN-подпиской',
    description: 'Покупка и продление подписки от вашего имени'
  },
  offline_access: {
    title: 'Долгий вход',
